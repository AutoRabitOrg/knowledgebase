...
Yes, this is achievable with assistance from AutoRABIT; however, your [Salesforce Orgs](/broken/pages/9pLgfInGvztETx4cXCc2) must be re-registered in AutoRABIT, and permissions provided to the relevant AutoRABIT users must be re-granted.
