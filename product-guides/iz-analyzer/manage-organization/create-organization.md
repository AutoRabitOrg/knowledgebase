...
2.  click on the plus icon beside profile icon -> Select **`Create New Organization`** -> Enter **`Organization Name`**-> click on **`Continue`**. <br>

    <figure><img src="../../../.gitbook/assets/create-organization-enter-org-details.png" alt=""><figcaption></figcaption></figure>
