...
4. Create an API token in AutoRABIT to connect to the extension. If you’re not aware of how to create an API token, refer to the documentation link: [Create API Token](../../troubleshoot/how-tos/create-api-token.md).
