...
* To scan the applications, either of the following options can be used -
  * [Using Maven](../ci-cd-integration/using-maven.md)
  * [Using IZ Scan CLI](../ci-cd-integration/using-iz-scan-cli.md)
{% endhint %}
...
4. Actions include -
   1. **`View Dashboard`** - Summary report of all the issues. [View Dashboard](../../iz-eye/anypoint-platform/application-dashboard.md)
   2. **`View Issues`** - Detailed report of the issues with file names and line numbers. [View Issues](../../iz-eye/application-issues.md)

### See Also

* [Mule Projects](../../iz-eye/anypoint-platform/applications/mule-applications.md)
* [Application Issues](../../iz-eye/application-issues.md)
