...
5. Choose the category: **metadata** or **data**.
   * **Data:** Select up to 10 **object(s)** from your [Salesforce Org](../../vault/configuring-vault/registering-salesforce-org/) and define the **alert threshold value**. Email notification triggers when this value is met.
