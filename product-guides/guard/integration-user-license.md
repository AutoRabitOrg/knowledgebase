...
| ------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Connecting a Salesforce Org to Guard              | Approve Uninstalled Connected Apps OR Create, Edit, and Delete External Client Apps OR Download AppExchange Packages | <p>The very first time an admin connects to the AutoRABIT Connected App, this permission is required so that Salesforce does not block the connection.</p><p>Once the connection is established, the admin should formally install the app and grant access through profile and permission sets. Future users will not need this permission.</p><p>An alternative is to use the AutoRABIT External Client App.<br>To create the external client app manually, you need the Create, Edit, and Delete External Client Apps. To install a managed package with the ECA, you need Download AppExchange Packages</p> |
| Risk Assessment                                   | (Modify All Data OR Modify Metadata Through Metadata API Functions), View Health Check, Manage Password Policies     | <p>The Risk Assessment uses the Metadata API to scan the metadata of an org and find misconfigurations.</p><p>Access to the Metadata API requires either Modify All Data or Modify Metadata Through Metadata API Functions.</p><p>To categorize and remediate some of the misconfigurations, the View Health Check and Manage Password Policies permissions are required.</p>                                                                                                                                                                                                                                   |
| Automated Data Classification                     | Customize Application (Optional)                                                                                     | Automated Data Classification automatically classifies custom fields against major regulations. This doesn't require any specific user permissions. To sync the regulations back to Salesforce, "Customize Application" is required because the sync edits the custom field definitions.                                                                                                                                                                                                                                                                                                                        |
| Access Control Policies / Authorization Policies  | Assign Permission Sets                                                                                               | This feature allows Guard to remove permission sets from unauthorized users. To remove permission set assignments, Assign Permission Sets is required.                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
| Digital Experience Assessment                     | Modify All Data OR View  All Data OR Create and Set Up Experiences OR membership of each Experience Cloud site       | Users with Modify All Data, View All Data or Create and Set Up Experiences can see all sites in the org.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
