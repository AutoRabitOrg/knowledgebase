...
If you are the current Administrator of your AutoRABIT Vault account and wish to transfer administrative privileges to another user, please email [support@autorabit.com](mailto:support@autorabit.com) with the following details:
