...
AutoRABIT Vault allows administrators to restrict user access to specific Salesforce orgs registered within the account. Based on access permissions, users can perform AutoRABIT Vault operations such as **backup**, **restore**, **replication**, **comparison**, and **archival** on authorized Salesforce orgs only.
...
If this toggle is **disabled**, all users in the AutoRABIT Vault account will have **unrestricted access** to all registered Salesforce orgs.

<figure><img src="../../../.gitbook/assets/image (86) (1) (1) (1) (1) (1).png" alt="Enable Org Access Control Toggle"><figcaption></figcaption></figure>
...
4. Users are limited to performing AutoRABIT Vault operations within those assigned orgs.
