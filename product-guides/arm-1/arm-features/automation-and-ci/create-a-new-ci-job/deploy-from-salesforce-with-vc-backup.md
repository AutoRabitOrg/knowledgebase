...
Once you filled in all the details for your CI job, you will be redirected to the [CI Job Results](../../../../arm/arm-features/ncino/feature-ci-jobs-1/ci-job-results.md) page where you can trigger a build for your CI job.
