...
This guide explains the AutoRABIT Vault Freemium trial registration workflow. The flow covers account creation, region selection, agreement acknowledgment, email notifications, trial access details, free trial limits, and OTP verification required to continue into the trial instance.

## Workflow Summary

<table data-header-hidden><thead><tr><th valign="top"></th><th valign="top"></th><th valign="top"></th></tr></thead><tbody><tr><td valign="top">Step</td><td valign="top">Purpose</td><td valign="top">Result</td></tr><tr><td valign="top">Start registration</td><td valign="top">Open the Freemium sign-up experience from the AutoRABIT Vault login page.</td><td valign="top">The registration form is displayed.</td></tr><tr><td valign="top">Enter registration details</td><td valign="top">Capture the required account, organization, email, and region information.</td><td valign="top">The trial request is prepared with the selected region.</td></tr><tr><td valign="top">Accept the agreement</td><td valign="top">Review and acknowledge the AutoRABIT Vault Agreement before submitting the request.</td><td valign="top">The Sign up action becomes available.</td></tr><tr><td valign="top">Submit the request</td><td valign="top">Send the completed registration details to AutoRABIT Vault.</td><td valign="top">AutoRABIT Vault processes the request and sends email notifications.</td></tr><tr><td valign="top">Review the emails</td><td valign="top">Use the received emails to confirm OTP and trial activation details.</td><td valign="top">The OTP, instance URL, master code, trial period, and limits are available.</td></tr><tr><td valign="top">Verify OTP</td><td valign="top">Enter the OTP sent to the registered email address.</td><td valign="top">The account verification step is completed.</td></tr></tbody></table>
...
After the registration request is processed, AutoRABIT Vault sends email notifications from No Reply Freemium \<no-reply-freemium@autorabit.com>. The flow includes an OTP email for verification and a trial activation email that confirms the trial account status and provides access details.
...
<table data-header-hidden><thead><tr><th valign="top"></th><th valign="top"></th></tr></thead><tbody><tr><td valign="top">Email field</td><td valign="top">Details shown in the screenshot</td></tr><tr><td valign="top">Subject</td><td valign="top">Welcome to AutoRABIT Vault - Your Free Trial is Active!</td></tr><tr><td valign="top">Sender</td><td valign="top">No Reply Freemium &#x3C;no-reply-freemium@autorabit.com></td></tr><tr><td valign="top">Greeting</td><td valign="top">Hi Test,</td></tr><tr><td valign="top">Welcome message</td><td valign="top">Welcome to Vault!</td></tr><tr><td valign="top">Activation confirmation</td><td valign="top">Your registration has been successfully completed, and your account is now active. You are ready to begin using AutoRABIT Vault.</td></tr><tr><td valign="top">Next Step</td><td valign="top">Add a Source Org from the dashboard to start configuring backup and other AutoRABIT Vault operations.</td></tr></tbody></table>
