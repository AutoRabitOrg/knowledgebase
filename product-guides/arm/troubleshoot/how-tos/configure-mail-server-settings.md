...
{% hint style="info" %}
**Important Note:** The first channel you add is automatically configured to all the events by default. To remove the channel from any notification type, click on the![](<../../../../.gitbook/assets/image (760).png>)icon. Channels added after that will have to be configured to events manually.
{% endhint %}
...
<figure><img src="../../../../.gitbook/assets/image (765).png" alt="" width="554"><figcaption></figcaption></figure>
