...
[**Release Note**](https://knowledgebase.autorabit.com/overview/release-notes/codescan-release-notes/on-premise-releases/release-notes-24.0.1)
...
1. Download the latest compatible CodeScan version (currently **24.0.1**) from [here](https://license.code-scan.com/index.php/download/login?path=sonar-salesforce-plugin-24.0.1.zip).
