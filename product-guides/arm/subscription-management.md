...
4. Only delegated or released users list will be displayed in Team Administrator dropdown field. If you want more information on delegate or released users, please refer [HERE](delegate-approvals-to-another-user.md).
