...
5. Once validated, add your [Salesforce Org](../../registration/salesforce-org/), Remote Repository, or Branch to the VS Code extension. Refer to the [VS Code Extension](../../../arm/integration-and-plugins/visual-code-extension/installing-vs-code-extension.md) guide for setup.
