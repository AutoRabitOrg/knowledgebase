...
6. Select the **PublicCalendarDelete** checkbox available under **Public Calendar.**
7. Click **Add**.
8. On the next screen, you will find a **Test Case Name** appear automatically by default. Give a name to a Label in the **Label Name** field.
