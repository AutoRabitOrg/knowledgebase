...
The **Stale Jobs** feature in AutoRABIT Vault enables administrators to monitor and manage jobs that have stalled during execution. Any job that remains inactive—i.e., without backend file updates—for **four consecutive days** is flagged as a _Stale Job_.

***

### Introduction

AutoRABIT Vault manages stale jobs using a two-pronged approach:
...
5.  **Notifications:**
    ...
    * **Multiple Job Termination**:
    ...
    ![Termination Notification](<../../../../.gitbook/assets/image (5) (5).png>)
