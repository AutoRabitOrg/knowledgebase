...
2.  Click on the **`New EZ-Merge`** button.
    ...
    * The **`New EZ-Merge`** screen is best viewed when the zoom setting is set to 80% on your Chrome/Firefox browser.
    ...
    <figure><img src="../../../../../.gitbook/assets/image (4) (1) (1) (1) (1) (1) (1).png" alt="" width="502"><figcaption></figcaption></figure>
...
6.  Select the **`Merge Type`** from the dropdown:
    ...
    * `ALM Label`
    ...
    <figure><img src="../../../../../.gitbook/assets/image (3) (1) (1) (1) (1) (1) (1) (1).png" alt="" width="431"><figcaption></figcaption></figure>
...
Merge a Single Revision from the Commits that you have performed. You can either enter the revision number (in case you remember it) or use the **`Search`** (![](<../../../../../.gitbook/assets/image (6) (1) (1) (1) (1) (1) (1).png>)) button next to the **`Single Revision`** field to pull a list of revisions from which you can choose the revision to use in the deployment.
...
2. The Work Item will gather all of the user stories for which the ALM commits happened in the Source Branch of the chosen Version Control Repository. Click on the **`Search`** (![](<../../../../../.gitbook/assets/image (16) (1) (1) (1) (1) (1).png>)) icon to find the list of user stories or work items fetched.

<figure><img src="../../../../../.gitbook/assets/image (17) (1) (1) (1) (1) (1).png" alt="" width="420"><figcaption></figcaption></figure>
...
<figure><img src="../../../../../.gitbook/assets/image (18) (1) (1) (1) (1) (1).png" alt="" width="360"><figcaption></figcaption></figure>
...
<figure><img src="../../../../../.gitbook/assets/image (31) (1) (1) (1) (1) (1).png" alt="" width="377"><figcaption></figcaption></figure>
