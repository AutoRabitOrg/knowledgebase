...
6. Select the **ActiveQuote** checkbox available under **Quote Templates**
7. Click **Add**.
...
9. Enter the required quote value in the **Active Value** field, then click on **Save** button to save this page.
