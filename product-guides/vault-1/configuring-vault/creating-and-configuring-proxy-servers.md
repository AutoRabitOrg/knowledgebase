...
This guide details how to configure a proxy server within AutoRABIT Vault. It explains how to forward requests from AutoRABIT Vault to proxied servers across various protocols and how to modify request headers sent to these servers.

AutoRABIT Vault includes proxy details in the request headers when connecting to external customer networks.
