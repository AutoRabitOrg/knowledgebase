...
Previously, we had [GitHub](../../../../arm/arm-features/automation-and-ci/enabling-github-checks.md) and Bitbucket support. We've included support for [Azure DevOps](../../../../arm/integration-and-plugins/azure-devops.md) in the ARM 21.6 release.
...
2. On the **EZ-Commit** screen, select the [**Salesforce Org**](../../../../arm/arm-administration/registration/salesforce-org/) from which the metadata components will get fetched.
