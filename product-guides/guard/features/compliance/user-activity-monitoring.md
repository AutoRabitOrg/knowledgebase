...
* **Users Table**: A detailed list of all Salesforce users, including:
  ...
  * User Flags (if applicable)
    * ![](<../../../../.gitbook/assets/image (1) (1) (1).png>)= Locked. User has had their password locked and is unable to sign in until it is reset.
    * ![](<../../../../.gitbook/assets/image (2) (1) (1).png>)= Frozen. User is blocked from logging in.
