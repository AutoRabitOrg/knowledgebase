...
1.  Navigate to **`IZ Pulse`** -> **`Endpoints`** and click on the **`Plus`** icon to view all the versions <br>

    <figure><img src="../../../../../.gitbook/assets/endpoint-versions.png" alt=""><figcaption></figcaption></figure>
2. Details include:
