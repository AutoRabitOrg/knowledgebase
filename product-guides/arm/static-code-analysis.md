...
To run a static code tool on your [Salesforce Org](getting-started/arm-administration/registration/salesforce-org.md) or Version Control Branch, follow the below steps:
