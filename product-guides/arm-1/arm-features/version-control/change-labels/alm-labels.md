...
1. Navigate to the left navigation pane, select Version Control, and click **Manage Labels** from the dropdown.
2. Then, select **ALM Labels** from the top navigation bar.
