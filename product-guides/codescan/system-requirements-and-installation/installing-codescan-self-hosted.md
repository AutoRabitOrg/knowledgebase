...
[**Release Note**](https://knowledgebase.autorabit.com/overview/release-notes/codescan-release-notes/cloud-releases/release-note-23.1.0)
...
1. Download the latest compatible CodeScan version (currently **23.1.6**) from [here](https://license.code-scan.com/index.php/download/login?path=sonar-salesforce-plugin-23.1.6.zip).
