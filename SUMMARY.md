...
* [CodeScan](product-guides/codescan/README.md)
  ...
  * [Getting Started](product-guides/codescan/getting-started/README.md)
    ...
    * [Setting up a CodeScan Cloud Organization](product-guides/codescan/getting-started/setting-up-a-codescan-cloud-organization/README.md)
      ...
      * [Adding Projects to CodeScan](product-guides/codescan/getting-started/setting-up-a-codescan-cloud-organization/adding-projects-to-codescan/README.md)
        * [Add a project to CodeScan from Salesforce](product-guides/codescan/getting-started/setting-up-a-codescan-cloud-organization/adding-projects-to-codescan/add-a-project-to-codescan-from-salesforce.md)
        * [Add a project to CodeScan from GitHub](product-guides/codescan/getting-started/setting-up-a-codescan-cloud-organization/adding-projects-to-codescan/add-a-project-to-codescan-from-github.md)
        * [Add a Project to CodeScan from Bitbucket](product-guides/codescan/getting-started/setting-up-a-codescan-cloud-organization/adding-projects-to-codescan/add-a-project-to-codescan-from-bitbucket.md)
        * [Add a Project to CodeScan from Git](product-guides/codescan/getting-started/setting-up-a-codescan-cloud-organization/adding-projects-to-codescan/add-a-project-to-codescan-from-git.md)
        * [Add a project to CodeScan from GitLab](product-guides/codescan/getting-started/setting-up-a-codescan-cloud-organization/adding-projects-to-codescan/adding-a-project-to-codescan-from-gitlab.md)
      * [Viewing Project Activity](product-guides/codescan/getting-started/setting-up-a-codescan-cloud-organization/viewing-project-activity.md)
