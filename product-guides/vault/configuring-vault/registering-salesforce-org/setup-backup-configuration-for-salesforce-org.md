...
5. Click on the **`email notification`**<img src="../../../../.gitbook/assets/image (68) (1).png" alt="" data-size="line">icon to select users from the list who will receive an email notification whenever the objects are backed up from your Salesforce Org.
