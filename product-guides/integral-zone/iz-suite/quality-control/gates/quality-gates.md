...
1.  Navigate to **`Quality Control`** -> **`Quality Gates`** <br>
    ...
    <figure><img src="../../../../../.gitbook/assets/quality-gates.png" alt=""><figcaption></figcaption></figure>
2. Details include -
   ...
   3. **`Actions`** - Actions include -
      ...
      2.  **`Activate In Org`** - Activate the Quality Gate in any of the available organizations<br>

          <figure><img src="../../../../../.gitbook/assets/activate-qg-in-org.png" alt=""><figcaption></figcaption></figure>
