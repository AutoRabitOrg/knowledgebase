...
AutoRABIT Vault allows users to define data masking rules at the organization level, enabling secure data anonymization during operations such as backup or replication.
...
![Select Org](<../../../../.gitbook/assets/image (121).png>)
