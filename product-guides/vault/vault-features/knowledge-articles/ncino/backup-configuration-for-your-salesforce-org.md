...
2. Click on the![](<../../../../../.gitbook/assets/image (77) (1) (1).png>)icon to go to the **Backup Setting** page which allows you to enable Bulk API retrieval.
...
11. **Additional options**:
    ...
    * **Backup Config Details**: Click on the![](<../../../../../.gitbook/assets/image (78) (1) (1).png>)icon to view the list of metadata/data members of Salesforce org that will be backed up based on the process scheduled.
    * **Actions (Edit/Delete)**:  The user can either delete the backup scheduled using Delete (![](<../../../../../.gitbook/assets/image (79) (1) (1).png>)) icon or update the metadata/data components from being backed up using the **Edit** (![](<../../../../../.gitbook/assets/image (80) (1) (1).png>)) icon.
