...
Click **`Save,`** and you will be redirected to the [Feature Migration Summary](feature-migration-summary-page.md) screen, where you can track your recently created template .
