...
6. Select the **ResourcesCalendarNew** checkbox available under **Resource Calendar**.
7. Click **Add**.
...
9. Give a name to a label in the **Label Name** fields and to activate the label, select the **Active Label** checkbox. Click the **Save** to save this page.
