...
The user can schedule an Apex class that implements the 'Schedulable' interface to be automatically executed monthly using this template.
...
6. Select the **ScheduleApexClassesMonthly** checkbox available under **Schedule Monthly Apex Class Job**.
7. Click **Add**.
