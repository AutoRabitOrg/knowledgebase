...
AutoRABIT Guard is the ultimate solution for enterprises to secure their Salesforce environments, ensure compliance, and unlock their full potential. By automating critical processes like monitoring, policy enforcement, and remediation, Guard eliminates manual work, reduces risk, and allows teams to focus on strategic initiatives.&#x20;

### Why Guard Your Organization?

Salesforce is at the heart of enterprise operations, yet its complexity often creates security blind spots. Traditional tools can’t effectively handle Salesforce’s unique challenges, leaving organizations exposed to misconfigurations, access gaps, and compliance risks. AutoRABIT Guard fills this gap with intelligent automation and centralized governance, empowering enterprises to meet the highest security and compliance standards effortlessly.&#x20;
...
* **Automated Remediation**: Go beyond alerts—Guard fixes issues automatically, saving you time and reducing operational overhead.&#x20;
...
* **Chief Information Officers (CIOs)**: Safeguard critical customer data, maintain compliance, and protect your organization’s reputation with a reliable, automated solution.&#x20;

## Getting Started > Connect a Salesforce Org&#x20;

Follow these simple steps to securely connect your Salesforce org to AutoRABIT Guard using OAuth:&#x20;

1. Log in to Guard.&#x20;
2. Navigate to the Admin > Salesforce Orgs section and click Add New Org.&#x20;
3. Select Environment.&#x20;
4. Choose Production or Sandbox based on your Salesforce org type.&#x20;
5. Authenticate in Salesforce.&#x20;
6. Log in using your Salesforce credentials.&#x20;
7. If prompted, complete Multifactor Authentication (MFA).&#x20;
8. Grant Permissions.&#x20;
9. Review the requested permissions and click Allow.&#x20;
10. Success!&#x20;
11. You’ll be directed to Guard, and your Salesforce org will now appear in the Salesforce Orgs list.&#x20;

You're all set! &#x20;

## Guard Features > Risk Assessment&#x20;

The Risk Assessment feature in AutoRABIT Guard provides an instant, comprehensive view of your Salesforce org's security posture. As soon as you connect your Salesforce org, AutoRABIT Guard automatically evaluates your security settings against a defined security baseline, presenting you with actionable insights.&#x20;

<figure><img src="../.gitbook/assets/Screenshot 2025-02-03 at 8.44.16 AM.png" alt=""><figcaption><p>Guard Risk Assessment</p></figcaption></figure>
...
3. **Categorized Risks**&#x20;
   1. Risks are categorized into two sections: &#x20;
      1. Risks You Can Resolve Automatically: Items that can be fixed directly within AutoRABIT Guard by clicking the Auto Fix button.&#x20;
...
4. **Baseline Comparison**&#x20;
   1. AutoRABIT Guard reads your Salesforce org’s security settings and compares them against recommended values. Any misaligned settings are highlighted, helping you quickly identify vulnerabilities.&#x20;
5. **Centralized View**&#x20;
...
1. **Connect Your Org**&#x20;
   1. Once connected, AutoRABIT Guard automatically performs a risk assessment.&#x20;
2. **Review** **Results**&#x20;
...
By centralizing all security insights into one view, AutoRABIT Guard ensures your Salesforce org is always secure and aligned with your organization’s policies.&#x20;

## Guard Features > Permissions Explorer&#x20;

### Overview&#x20;

The Permissions Explorer in AutoRABIT Guard simplifies Salesforce permission analysis by categorizing common Salesforce permissions into traditional IT security categories. This makes it easier for security professionals to understand and evaluate Salesforce-specific permissions in the context of their organization's security policies.
...
* **Identify Overprivileged Users**: Quickly locate users with excessive or unnecessary permissions and take corrective action to enforce the principle of least privilege.&#x20;
* **Simplify Permission Audits**: Gain a clear understanding of who has access to critical permissions and how they were granted, streamlining compliance audits.&#x20;
* **Enhance Security Posture**: By aligning Salesforce permissions with traditional security categories, your security team can better identify and mitigate potential risks.&#x20;

### How Permissions Explorer Works&#x20;
...
* **Complete Audit Trail**: Gain full visibility into every modification in your production org, ensuring transparency and accountability.&#x20;
* **Streamlined Investigations**: Use advanced filters to quickly pinpoint specific changes, saving time during audits or troubleshooting sessions.&#x20;
* **Improved Governance**: Ensure compliance with internal policies and external regulations by keeping a detailed log of all modifications.&#x20;
* **Enhanced Collaboration**: Help developers, admins, and security teams stay aligned by providing a single source of truth for all changes.&#x20;
...
## Guard Features > Change Monitoring Alerts&#x20;
...
* **Stay Informed**: Get real-time visibility into changes happening in your Salesforce org, ensuring no critical updates go unnoticed.&#x20;
* **Enhance Governance**: Monitor compliance by keeping track of sensitive changes like profile creations or permission set modifications.&#x20;
* **Boost Team Accountability**: Ensure teams are aware of their changes and take ownership of their actions.&#x20;
* **Prevent Undesired Configurations**: Catch and address unauthorized or accidental changes before they escalate into larger issues.&#x20;

## Policies&#x20;

The Policies feature in AutoRABIT Guard introduces a completely new way to enforce governance and security in your Salesforce org. Unlike Salesforce’s native functionality, Policies allow you to define strict rules—such as permission set allow lists—that determine who can access specific permission sets. This ensures that sensitive permissions are only granted to authorized users. Guard monitors your org in real time and takes immediate action if violations are detected, making this feature the backbone of secure and compliant Salesforce operations.&#x20;
...
2. **Real-Time Monitoring and Enforcement**&#x20;
   1. Guard scans your org every five minutes to detect violations.&#x20;
...
5. **Scalable Governance Framework**&#x20;
   1. Policies are the foundation of Guard's governance features and will soon support additional capabilities, including password policies and governance rules.&#x20;

### Benefits of Policies&#x20;

* **Enforce Governance with Automation**: Automate the enforcement of access rules to eliminate manual oversight and reduce the risk of human error.&#x20;
* **Protect Sensitive Data**: Prevent unauthorized users from accessing permissions that expose critical business data.&#x20;
* **Maintain Compliance**: Meet internal governance standards and external regulatory requirements with real-time enforcement.&#x20;
* **Boost Efficiency**: Save time and effort by automatically remediating violations or receiving actionable alerts for manual intervention.&#x20;

### How Policies Work

1. **Create a Policy**&#x20;
   1. Go to the Policies section in AutoRABIT Guard and click Add Policy.&#x20;
...
4. **Activate and Monitor**&#x20;
   ...
   2. Guard will monitor your Salesforce org every five minutes and enforce the policy as configured.
