...
1.  In **CodeScan**, click on the **`Profile`** icon on the right corner of the screen and select your organization (under **`My Organizations`**).\
    ...
    <figure><img src="../../../../.gitbook/assets/image (7) (1).png" alt=""><figcaption><p>Profile</p></figcaption></figure>
2.  Go to **`Administration > SAML Connections`**.\


    <figure><img src="../../../../.gitbook/assets/image (1) (1) (1) (1).png" alt="" width="375"><figcaption><p>SAML Connections</p></figcaption></figure>
3.  Click on **`Create Connection`**.\


    <figure><img src="../../../../.gitbook/assets/image (2) (1) (1) (1).png" alt=""><figcaption><p>Create Connection</p></figcaption></figure>
