...
To run a static code tool on your [Salesforce Org](../../../arm/arm-administration/registration/salesforce-org/) or Version Control Branch, follow the below steps:
...
9. **Download SCA Report**: Click on the **Download** (![](<../../../../.gitbook/assets/image (44) (1) (1) (1).png>)) icon to download the report in CSV format on your local device.
10. **Delete SCA process**: Click on the **Delete (**![](<../../../../.gitbook/assets/image (45) (1) (1) (1).png>)**)** icon to delete the SCA process configured for your org/anch. This cannot be undone.
...
<figure><img src="../../../../.gitbook/assets/image (46) (1) (1) (1).png" alt="" width="559"><figcaption></figcaption></figure>
