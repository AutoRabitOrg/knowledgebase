...
{% stepper %}
{% step %}
### Prereq: Get your Callback URL (redirect URI)

For AutoRABIT’s ARM ECA setup, you need **the callback URL**

The callback URL depends on the instance:
...
In the **Security** section, the following options should be enabled:
...
After getting the code and verifying in Salesforce, the Consumer Key (ClientID) and Consumer Secret (Client Secret) will be displayed.
...
In the menu, click Salesforce org and click Register Salesforce org.

<figure><img src="../../../../../.gitbook/assets/45539562-22e5-43c8-a071-1c4c8c29187c.png" alt=""><figcaption></figcaption></figure>

Create the connection by filling in the required information obtained from Salesforce.
...
A message from Salesforce will show to request granted permissions for the user to use the scopes defined in the ECA. Click Allow.
