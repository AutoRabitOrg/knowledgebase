...
9. However, you must add a deleting schedule for the auto-generated or your custom test case name. To add a schedule name, do the following:
   ...
   2. Enter the report in Deleting Schedule you wish to delete under the **Job Name** field.
   3. You can even add multiple schedule reports for the above-generated test case name. Click on the **+** symbol and fill in the fields mentioned in the earlier steps.&#x20;
