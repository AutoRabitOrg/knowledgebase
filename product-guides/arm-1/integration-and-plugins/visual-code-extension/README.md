...
### About Visual Studio Code Extension
...
VS Code extension allows our developers to commit code via a pre-validation framework, thereby boosting team productivity.

### Prerequisites

Before you get started working with the VS Code Extension, you need to:

1. Download the [Visual Studio Code installer](https://code.visualstudio.com/download) for your platform.
2. Install the [AutoRABIT Visual Studio Code extension](https://marketplace.visualstudio.com/items?itemName=autorabit-dev.autorabit) on your system.
...
4. Create an API token in AutoRABIT to connect to the extension. If you’re not aware of how to create an API token, refer to the documentation: [Create API Token](../../troubleshoot/how-tos/create-api-token.md).
5. Have a Version Control repo/branch registered within AutoRABIT.
6. Have a Salesforce Org configured within AutoRABIT.
