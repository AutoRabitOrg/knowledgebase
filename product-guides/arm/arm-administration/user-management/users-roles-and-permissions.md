...
> *Super Admin* and **the currently logged-in user** are locked for **all** user-management actions: they cannot be added, deleted, suspended, edited, or delegated.
...
2. Go to **Admin › Users** and click **Add User**.
   ...
   <figure><img src="../../../../.gitbook/assets/image (606).png" alt="Add User button in the Users list"></figure>

3. Fill **User Details** and assign **Role Permissions**.  
4. Choose **Save & Activate** (immediate) or **Save Now & Activate Later**.

   <figure><img src="../../../../.gitbook/assets/image (607).png" alt="User details form with role selection"></figure>
...
1. In **Admin › Users**, locate the user and click **Edit**.
   ...
   <figure><img src="../../../../.gitbook/assets/image (609).png" alt="Edit icon for user row"></figure>
...
* **Delete User** – permanently remove the account.
  ...
  <figure><img src="../../../../.gitbook/assets/image (610).png" alt="Trash-can icon to delete a user"></figure>

* **Activate / De-activate** – toggle suspension.

  <figure><img src="../../../../.gitbook/assets/image (611).png" alt="Activate/De-activate toggle button"></figure>
...
<figure><img src="../../../../.gitbook/assets/image (612).png" alt="Override Enforce SSO checkboxes for selected users"></figure>
...
1. In **Admin › Users**, click **Export All Users**.
   ...
   <figure><img src="../../../../.gitbook/assets/image (613).png" alt="Export All Users button"></figure>

2. Select fields and click **Export**.

   <figure><img src="../../../../.gitbook/assets/image (614).png" alt="Field-selection dialog for CSV export" width="511"></figure>
...
1. Go to **Admin › Roles**.
   ...
   <figure><img src="../../../../.gitbook/assets/image (615).png" alt="Roles option in Admin menu" width="251"></figure>

2. Click **Create Role**.

   <figure><img src="../../../../.gitbook/assets/image (616).png" alt="Create Role button"></figure>

3. Provide a **Role Name**, **Description**, and tick permissions.

   <figure><img src="../../../../.gitbook/assets/image (617).png" alt="Role permissions checklist" width="563"></figure>
...
1. Open **Admin › Permissions**.
   ...
   <figure><img src="../../../../.gitbook/assets/image (618).png" alt="Permissions tab in Admin menu" width="251"></figure>

2. Select two or more users and click **Bulk Assignment**.

   <figure><img src="../../../../.gitbook/assets/image (619).png" alt="Bulk Assignment button"></figure>

Admins are hidden on this screen because they already hold full access.

<figure><img src="../../../../.gitbook/assets/image (622).png" alt="Assign roles and modules to selected users"></figure>

<figure><img src="../../../../.gitbook/assets/image (621).png" alt="Save confirmation after assigning permissions" width="563"></figure>
