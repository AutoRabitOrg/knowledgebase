...
You can download the deployment, quick deployment, or rollback reports for your build by hovering the mouse over the (![](<../../../../.gitbook/assets/image (16).png>)) icon under the **Deployment Details** section.
