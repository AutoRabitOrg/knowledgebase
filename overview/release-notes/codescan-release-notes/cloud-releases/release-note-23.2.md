...
The issue occurs when executing "/\_codescan/billing/license" API due to a dependency of the host name ending with “.codescan.io” domain name.  In the case of the AWS team, they utilize an “.aws.dev” domain; thus, this code is not being executed.
