...
Tenant managers now have access to a "User Management" link in the UI. Clicking this link directs them to the management console. Non-tenant management users will not see this link. From here users can be created and/or edited.&#x20;
