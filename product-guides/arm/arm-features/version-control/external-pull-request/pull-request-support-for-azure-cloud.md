...
3.  On the next pop-up screen, furnish the below details:
    ...
    * Select your [**version control repository**](../introduction-to-version-control/version-control-repositories-summary.md). Only those version control repositories for which the pull request is enabled will be listed under the **Repositories** drop-down.
...
2. On the **EZ-Commit** screen, select the [**Salesforce Org**](/broken/pages/9pLgfInGvztETx4cXCc2) from which the metadata components will get fetched.
...
<figure><img src="../../../../../.gitbook/assets/image (54) (1) (1) (1) (1) (1) (1) (1).png" alt=""><figcaption></figcaption></figure>
...
9.  On the next screen, you need to do the following:
    ...
    * Enter the **Commit Comment**. This is a mandatory step.
    ...
    <figure><img src="../../../../../.gitbook/assets/image (55) (1) (1) (1) (1) (1) (1).png" alt=""><figcaption></figcaption></figure>
