...
* Downloaded and installed **`[SonarScanner™](https://docs.sonarqube.org/latest/analysis/scan/sonarscanner/)`** CLI plugin. Refer to [Installing Sonar Scanner](../../iz-suite/iz-scan/anypoint-studio/installation/install-plugin.md)
* Follow the instructions [here](../../iz-suite/iz-scan/anypoint-studio/installation/install-plugin.md) to generate security token
