...
6. Select the **ProductScheduleSettings** checkbox available under **Product Schedule**.
7. Click **Add.**
8.  On the next screen, you'll notice that a **Test Case Name** appears by default. Click the **Add** button to add the custom test data. Fill in the required information in the fields below, then click the **Save** button.
    ...
    <figure><img src="https://cdn.document360.io/8711f4e7-c040-4616-aac9-d947f87e4619/Images/Documentation/image-1632123373399.png" alt=""><figcaption></figcaption></figure>
