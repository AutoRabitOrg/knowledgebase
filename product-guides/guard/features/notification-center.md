...
Notifications you no longer need can be archived. Archiving removes them from your main inbox without deleting them, so you can still refer back to them if needed.
