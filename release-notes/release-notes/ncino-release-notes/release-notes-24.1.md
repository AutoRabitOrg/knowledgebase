...
1.  **Exclude the OwnerID from Automapping in nCino CI jobs**
    ...
    **Further documentation:** For more detailed information, please refer to our [Knowledge Base](../../../product-guides/arm/arm-features/ncino/feature-ci-jobs/running-a-ci-job/exclude-the-ownerid-from-automapping-in-ncino-ci-jobs.md). \
    &#x20;
...
3.  **Select External Unique Identifier During nCino Feature Deployment**
    ...
    **Further documentation:** For more detailed information, please refer to our [Knowledge Base](../../../product-guides/arm/arm-features/ncino/feature-ci-jobs/running-a-ci-job/select-external-unique-id.md).
