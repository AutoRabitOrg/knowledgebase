...
2. Please note that any new Salesforce org that you wish to register in CodeScan must use the new [local ECA flow](../../../../product-guides/codescan/getting-started/connecting-a-salesforce-org-to-codescan-using-local-eca-flow.md).<br>
