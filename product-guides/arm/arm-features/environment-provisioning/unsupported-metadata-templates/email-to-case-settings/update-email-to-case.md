...
9. However, you'll need to add routing address details for the auto-generated or your custom test case name. To add routing detail, do the following:
   ...
   2. Enter the routing address in the **Routing Address** field.&#x20;
   3. Enter the email id in the **New Email** field.&#x20;
   4. You can even add multiple routing addresses for the above-generated test case name. Click on the **+** symbol and fill in the fields as mentioned in the steps earlier.&#x20;
