...
To utilize Azure Blob as your storage medium for backing up metadata and data objects, follow these steps to configure it within the AutoRABIT Vault application:
...
<figure><img src="../../../../.gitbook/assets/image (118) (1).png" alt="Azure Blob storage configuration screen in Vault" width="563"><figcaption><p>Azure Blob configuration in Vault</p></figcaption></figure>
...
* Contact the **AutoRABIT CloudOps** team to configure [AutoRABIT Vault](https://www.autorabit.com/products/vault-data-backup-recovery/) as your default backup environment.
