...
1. Hover over **`Admin`** and click **`Credentials`**.
   ...
   <figure><img src="../../../../.gitbook/assets/image (630).png" alt="Admin menu with Credentials option highlighted" width="326"></figure>

2. Click **Create Credential**.

   <figure><img src="../../../../.gitbook/assets/image (631).png" alt="Create Credential button"></figure>
...
<figure><img src="../../../../.gitbook/assets/image (632).png" alt="Username with Password credential form" width="563"></figure>
...
<figure><img src="../../../../.gitbook/assets/image (633).png" alt="SSH credential form with key upload" width="563"></figure>
...
<figure><img src="../../../../.gitbook/assets/image (635).png" alt="HashiCorp Vault credential form with AWS Auth option" width="563"></figure>

*For details, see the dedicated [HashiCorp Vault guide](arm-credential-manager.md#hashicorp-vault).*
...
<figure><img src="../../../../.gitbook/assets/image (636).png" alt="SSH Certificate credential form" width="563"></figure>
...
<figure><img src="../../../../.gitbook/assets/image (637).png" alt="Application Token credential form for Jira integration"></figure>
