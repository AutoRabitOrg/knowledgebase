...
3.  Under the **Plugins** section, select the **Provar** checkbox.\
    ...
    <figure><img src="https://cdn.document360.io/8711f4e7-c040-4616-aac9-d947f87e4619/Images/Documentation/image-1664793855006.png" alt=""><figcaption></figcaption></figure>
4. Fill in Provar info in the next popup screen:
   1. **Name**: Enter a name of your choice (max. of 126 characters). The name should not include any special characters except **"-"**.
   2. **Web Browser Configuration**: Choose the Web Browser Configuration as **Desktop Full Screen**.&#x20;
   3. **Web Browser Provider Name**: Choose **Desktop** as Web Browser Provider Name.
   4. **Web Browser Device Name**: Choose the Web Browser Device Name as **Desktop Full Screen**.
   5. **Exclude Callable Test Cases:** To exclude callable test cases from execution, select this checkbox.
   6.  **LicenseFile**: Browse the provar license’s properties file from your local system and upload it here. This license file will be used by all users activated for their clients. You can even download the recently uploaded license file if needed.\
       ...
       * **lastOnlineAvailabilityCheckUtc=153078614616**
       ...
       <figure><img src="https://cdn.document360.io/8711f4e7-c040-4616-aac9-d947f87e4619/Images/Documentation/image-1664794029039.png" alt="" width="375"><figcaption></figcaption></figure>
...
1.  Set the Web Browser to **Desktop: Full Screen**
    ...
    <figure><img src="https://cdn.document360.io/8711f4e7-c040-4616-aac9-d947f87e4619/Images/Documentation/image-1623667459766.png" alt=""><figcaption></figcaption></figure>
2.  Select the **Provider Name** to **Desktop** and the **Browser Configurations** to **Full Screen**.

    <figure><img src="https://cdn.document360.io/8711f4e7-c040-4616-aac9-d947f87e4619/Images/Documentation/image-1623667475165.png" alt="" width="563"><figcaption></figcaption></figure>
...
4. Fill in the required Provar details to integrate with AutoRABIT:
   1. **Name (mandatory field):** Enter a name of your choice (max. of 126 characters). The name should not include any special characters except "-".
   2. **License File**: Browse the provar license’s properties file from your local system and upload it here. This license file will be used by all users activated for their clients.
   3. The license properties file should contain the information in the same order as shown below:
      * **#Thu Jul 05 15:52:26 IST 2018**
      * **licenseStatus=Activated**
      * **licenseType=FixedSeat**
      * **licenseKey=XXXXX-XXXXX-XXXXXX-XXXXX-XXXXX**
...
7.  Now, you need to add the **Test Cases Root path** and **Test Cases Execution path**.\
    ...
    1. **Test Cases Root path**: Enter the test case root path till the **.testproject** file
    2. **Test Cases Execution Path**: Enter the test cases execution path here. For example- tests/sample. If not specified, all the test cases from the **'tests'** folder will get executed.

    <figure><img src="https://cdn.document360.io/8711f4e7-c040-4616-aac9-d947f87e4619/Images/Documentation/image-1664794603526.png" alt="" width="563"><figcaption></figcaption></figure>
...
<figure><img src="https://cdn.document360.io/8711f4e7-c040-4616-aac9-d947f87e4619/Images/Documentation/image-756.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="https://cdn.document360.io/8711f4e7-c040-4616-aac9-d947f87e4619/Images/Documentation/image-744.png" alt=""><figcaption></figcaption></figure>
