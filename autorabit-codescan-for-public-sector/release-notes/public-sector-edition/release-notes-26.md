...
2. **GitHub Apps Integration for GitHub Enterprise in CodeScan**
...
3. **Added a new Resolution Status for Issues – “Exception”**
...
2\) Issues status changed to Exception (through single assign and bulk assign).

<figure><img src="../../../.gitbook/assets/image (5).png" alt=""><figcaption></figcaption></figure>

3\) Issues status changed from Exception to Open (Rollback) (through single assign and bulk assign).

<figure><img src="../../../.gitbook/assets/image (6).png" alt=""><figcaption></figcaption></figure>

4\) Able to view the Exception status in CSV Issues export (in list and downloaded CSV).

<figure><img src="../../../.gitbook/assets/image (7).png" alt=""><figcaption></figcaption></figure>

5\) Status visible in a single rule.

<figure><img src="../../../.gitbook/assets/image (8).png" alt=""><figcaption></figcaption></figure>

6\) Comments in Activity.
...
4. **New Email Notifications alert for Admins when  Project Analysis Errors occur** &#x20;
...
2. **Instance-Level Severity Masking**
...
4. **Rules Evaluation Export Report**
...
5. **Severity Selection for Custom Security Hotspots**
...
6. **Issue Exceptions Enhancements**
...
7. **Showing Invited Users in Members List with pending status**
...
8. **Improved Error Messaging in Invite Module for Existing Users**
...
9. **Added Default Salesforce Metadata file suffixes to CodeScan for customers running DX projects**
...
12. **Track Cursor IDE Usage in the VS Code Extension**
...
d. Confirmed that VS Code usage is accurately shown on the IDE Usage page and validated that cross-user usage visibility is also functioning as expected.



13. **Configurable Default User Role for SSO-Provisioned Users**
...
14. **Track Cursor IDE Usage on CodeScan 'IDE USAGE' Page**

**Description**

Captures the Cursor IDE usage details (User Name, IDE Type = Cursor, Timestamp) within CodeScan Cloud, allowing customers to track IDE adoption, user activity, and engagement trends alongside existing usage data.
...
* Rule key: _sfmeta:ConnectedAppMissingDescription_&#x20;
* Type: Code Smell &#x20;
...
2. **Connected App Uses High-Risk OAuth Scopes**
...
* Rule key: _sfmeta:ConnectedAppHighRiskScopes_&#x20;
* Type: Vulnerability &#x20;
* Default Severity: Major &#x20;
* CWE: CWE-272 &#x20;
...
3. **Avoid Plain Text Values in External Credential Parameters**
...
4. &#x20;**Added CVSS Scoring for Security Rules**
...
5. **Enhanced AvoidDMLInLoops Rule with Interprocedural Analysis**
...
3. **GitHub Enterprise Integration Improvements**
...
4. **Resolved User Invitation and Group Assignment Issues**
...
5. **Analysis Permission Validation Improvements**
...
6. **Improved Handling for Invalid Base Branches in Comparison and Pull Request Analysis**
...
7. **Improved Validation for Comparison Branch Analysis Without Main Branch Baseline**
...
8. **Support for Special Characters in Salesforce Organization Names**
...
9. **Resolved Salesforce Connection Deletion Issue with Special Characters in Connection Names**
...
10. **Resolved Duplicate Email Notifications and Organization Deletion Exceptions**
...
11. **Resolved Stack Overflow Issue in Field-Level Security Rule Analysis**
...
12. **Fix for Incorrect "No Scan Access for Project" Error During Analysis Execution**
...
13. **Resolved “No Scan Access for Project” Error During Analysis Execution**
...
15. **Resolved Intermittent Delays in PR-Scoped EZ-Commit Analysis Jobs**
...
16. **Resolved Tag Filter Issue on CodeScan Rules Page**
...
17. **UI Now Displays Actual Duplicate Project Key Message During Project Creation instead of Generic “Unknown Error” Message**
...
18. **Resolved Blank Edit Project Settings Page for S3 Integration Projects**
...
19. **Improved Validation for Salesforce User Permissions During ECA Authentication**&#x20;
...
20. **Resolved 403 Error When Activating Rules in US Instance**&#x20;
...
21. **Resolved “Component cannot be null” Error in Cross Object Formula Overuse Rule**&#x20;
...
23. **Fixed issue with rule “Unescaped Error Message XSS”**&#x20;

{Rule ID: sf:UnescapedOutput}
...
24. **Fixed issue with rule “Avoid Cleartext Transmission of Sensitive Information”**
...
25. **Fixed issue with rule “Field Level Security Vulnerabilities” {Rule ID: sf:FieldLevelSecurity}**
...
26. **Fixed issue with rule “Resource Injection”**&#x20;
...
* Analysis no longer remained in the running state
...
27. &#x20;**Custom Rule creation validation update**

Resolved an inconsistency between custom rule creation and update workflows. Previously, the update flow enforced stricter validation on the description field, restricting certain formats (e.g., descriptions containing HTTP/HTTPS protocols).&#x20;
...
## AutoRABIT CodeScan PubSec 26.0.2 Release Notes

**Release Date: 21 April 2026**

### Summary

AutoRABIT CodeScan PubSec 26.0.2 is comprised of the following 8 components:
...
## AutoRABIT CodeScan PubSec 26.0.1 Release Notes

**Release Date: 18 January 2026**

### Summary

AutoRABIT CodeScan PubSec 26.0.1. is comprised of the following 4 components:
