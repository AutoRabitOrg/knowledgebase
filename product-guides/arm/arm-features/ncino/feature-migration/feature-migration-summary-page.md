# Feature Management Summary Page

### Overview <a href="#overview" id="overview"></a>

The Feature Management page lists all the standard and community templates created to date. Users can filter templates using the Source Type dropdown, which provides the Community and Standard options.

\
Templates that are in progress or in a draft state are available under the Community source type. Once published, they are listed under the Standard source type, making them available for customers.
