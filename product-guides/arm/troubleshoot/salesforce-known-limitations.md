...
3. Salesforce restricts access to create an **External Id** for the following objects in AutoRABIT. These listed objects are not supported in **Dataloader Pro **_**(**for more details, refer_ _to_ [_How to perform Dataloader Pro Operation_](../arm-features/dataloader-pro.md), step 6_**)**_ and **Test Environment Setup **_**(**for more details, refer to_ [_Create a New Test Environment Setup_](../arm-features/test-environment-setup.md)_, step 5**)**_.
