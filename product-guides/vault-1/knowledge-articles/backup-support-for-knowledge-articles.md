...
For more details on how to restore or replicate Knowledge Articles, [check this article](../../vault/vault-features/knowledge-articles/restoring-knowledge-articles-with-vault.md).
