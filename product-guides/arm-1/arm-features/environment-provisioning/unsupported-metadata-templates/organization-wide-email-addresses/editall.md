...
8.  On the next screen, you'll notice that a **Test Case Name** appears by default. Click the **Add** button to add the custom test data. Fill in the required information in the fields below.
    ...
    * Enter the details in **Editing Name, Display Name,** and **Email Address** fields. Select the **All Profile** checkbox to activate these fields.
    * To select profile, click on![](<../../../../../../.gitbook/assets/image (14) (1) (1) (1) (1).png>)icon.
