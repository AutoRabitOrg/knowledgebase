...
5. Once validated, add your [Salesforce Org](/broken/pages/9pLgfInGvztETx4cXCc2), Remote Repository, or Branch to the VS Code extension. Refer to the [Installing VS Code Extension](../../../arm/integration-and-plugins/visual-code-extension/installing-vs-code-extension.md) guide for setup.
