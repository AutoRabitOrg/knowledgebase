...
ARM has a 90-day rotational policy that requires you to change your password in every 90 days. Follow the instruction [HERE](../../product-guides/arm/reset-account-password.md) to reset your ARM password.
...
Yes, this is achievable; however, your [Salesforce Orgs](../../product-guides/arm/getting-started/arm-administration/registration/salesforce-org.md) must be re-registered in AutoRABIT, and permissions provided to the relevant AutoRABIT users must be re-granted.
