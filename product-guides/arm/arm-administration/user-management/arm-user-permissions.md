...
1.  From the **`Admin`** module, open the **`Permissions`** tab.
    ...
    <figure><img src="../../../../.gitbook/assets/image (618).png" alt="Admin menu with Permissions tab selected" width="251"><figcaption></figcaption></figure>
2.  Select one or more users:

    * **Single user** – click the person’s first name.
    * **Bulk assignment** – tick the checkboxes for at least **two** users.

    <figure><img src="../../../../.gitbook/assets/image (619).png" alt="Permissions list with checkboxes for bulk assignment"><figcaption></figcaption></figure>
...
5.  You can always click a name later to revisit that user’s detail view.
    ...
    <figure><img src="../../../../.gitbook/assets/image (620).png" alt="User detail view showing role and module assignments"><figcaption></figcaption></figure>

    <figure><img src="../../../../.gitbook/assets/image (621).png" alt="Save button for user permissions" width="563"><figcaption></figcaption></figure>
