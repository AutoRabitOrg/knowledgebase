...
A **package** is a container of related metadata—features, customizations, and schema—that you move from one [Salesforce org](/broken/pages/9pLgfInGvztETx4cXCc2) to another.
