...
* Backup configured for your Salesforce Org. \[[Learn More](../../configuring-vault/salesforce-org-setup/setup-backup-configuration-for-salesforce-org.md)]
...
3. On the next screen, select your source [**`Salesforce Org`**](../../configuring-vault/salesforce-org-setup/registering-salesforce-org/).
