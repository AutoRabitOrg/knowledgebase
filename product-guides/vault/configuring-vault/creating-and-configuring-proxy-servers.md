...
6. Using the **Edit** (![](<../../../.gitbook/assets/image (66) (1) (1).png>)) icon, you can later edit the proxy setups or **Delete** (![](<../../../.gitbook/assets/image (67) (1) (1).png>)) any proxy that is no longer needed.
