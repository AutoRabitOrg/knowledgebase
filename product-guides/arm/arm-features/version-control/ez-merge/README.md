...
2.  Click on the **`New EZ-Merge`** button.
    ...
    * The **`New EZ-Merge`** screen is best viewed when the zoom setting is set to 80% on your Chrome/Firefox browser.
    ...
    <figure><img src="../../../../../.gitbook/assets/image (4).png" alt="" width="502"><figcaption></figcaption></figure>
...
6.  Select the **`Merge Type`** from the dropdown:
    ...
    * `ALM Label`
    ...
    <figure><img src="../../../../../.gitbook/assets/image (3).png" alt="" width="431"><figcaption></figcaption></figure>
...
2. The Work Item will gather all of the user stories for which the ALM commits happened in the Source Branch of the chosen Version Control Repository. Click on the **`Search`** (![](<../../../../../.gitbook/assets/image (16).png>)) icon to find the list of user stories or work items fetched.

<figure><img src="../../../../../.gitbook/assets/image (17).png" alt="" width="420"><figcaption></figcaption></figure>
...
<figure><img src="../../../../../.gitbook/assets/image (31).png" alt="" width="377"><figcaption></figcaption></figure>
