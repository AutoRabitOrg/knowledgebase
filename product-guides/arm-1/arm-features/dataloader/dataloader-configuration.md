...
### DataLoader Configuration <a href="#dataloader-configuration-overview" id="dataloader-configuration-overview"></a>
...
Example: If Account records are migrated from Sandbox to Production, and some records already exist in Production, configuring an External ID ensures that matching records are updated rather than duplicated. This maintains data integrity and consistency across environments.
