...
YThe following compatibility chart identifies the SonarQube version compatible with the CodeScan Plug-In version. For on-premises clients, please contact your CSM for compatibility support.
