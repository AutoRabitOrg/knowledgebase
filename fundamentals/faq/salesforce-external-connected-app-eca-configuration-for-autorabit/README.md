...
AutoRABIT products (CodeScan, Guard, and Vault) connect to a customer Salesforce org using a Salesforce External Client App (ECA). Follow the product-specific guides to create or reuse an ECA, capture the Client ID and Client Secret, and complete the connection setup and user authorization required for that product.
