...
CodeScan Self-Hosted version **23.1.1** _(compatible with **SonarQube™ 9.9 version or earlier—not currently supporting version 10)**_ is the latest CodeScan release. We strongly recommend all CodeScan users upgrade to this iteration.

[**Download**](https://license.code-scan.com/index.php/download/login?path=sonar-salesforce-plugin-23.1.1.zip)

[**Release Note**](https://knowledgebase.autorabit.com/codescan/docs/release-note-2310#12-may-2023)
