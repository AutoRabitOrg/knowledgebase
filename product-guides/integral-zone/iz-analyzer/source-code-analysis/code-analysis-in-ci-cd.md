...
* Downloaded and installed **`[SonarScanner™](https://docs.sonarqube.org/latest/analysis/scan/sonarscanner/)`** CLI plugin. Refer to [Installing Sonar Scanner](../../iz-suite/iz-scan/anypoint-studio/installation/install-iz-analyzer-studio.md)
* Follow the instructions [here](../../iz-suite/iz-scan/anypoint-studio/installation/install-iz-analyzer-studio.md) to generate security token
...
* [Code Analysis In Anypoint Studio](../../../iz-analyzer/source-code-analysis/code-analysis-in-studio.md)
