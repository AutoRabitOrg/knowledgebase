...
Administrators or users with administrative roles can view and manage the ongoing backup schedules for the Salesforce Org associated with their AutoRABIT Vault account.

### Procedure <a href="#procedure" id="procedure"></a>

1. Log in to your **AutoRABIT Vault** account.
2. Navigate to **Settings > Scheduling Options** tab.
3. Select your [**Salesforce Org**](../../vault/configuring-vault/registering-salesforce-org/). AutoRABIT Vault will display the list of scheduled backups for the selected org.
