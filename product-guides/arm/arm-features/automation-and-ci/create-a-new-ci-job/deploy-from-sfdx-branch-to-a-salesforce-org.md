---
description: How to Deploy from an SFDX Branch to a Salesforce Org
---

# Deploying from SFDX Branch to a Salesforce Org
...
*   Provar (if Provar plugin is installed in ARM)\
    ...
    <div data-full-width="false"><figure><img src="../../../../../.gitbook/assets/image (1895).png" alt=""><figcaption></figcaption></figure></div>
