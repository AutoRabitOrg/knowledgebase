...
1.  Navigate to **`Rules`** -> **`Metric Rules`** <br>

    <figure><img src="../../../../../.gitbook/assets/metric-rules.png" alt=""><figcaption></figcaption></figure>
2. Details include -
...
3.  Click on **`Activate In Profile`** action to activate the metric in any of the Metric Profiles\
    ...
    <figure><img src="../../../../../.gitbook/assets/activate-metric-in-profile.png" alt=""><figcaption></figcaption></figure>
