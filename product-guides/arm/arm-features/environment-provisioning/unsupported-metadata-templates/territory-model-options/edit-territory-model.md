...
8.  On the next screen, you'll notice that a **Test Case Name** appears by default. Click the **Add** button to add the custom test data. Fill in the required information in the fields below.
    ...
    1. &#x20;**Label Name Edit** and **Label Name**
    2. **Territory Model Name:** Enter the Territory model name in this field.
    3. **Territory Description:** Add the description if required.
    4. Once you are finished, click **Save** to save this page.

    <figure><img src="https://cdn.document360.io/8711f4e7-c040-4616-aac9-d947f87e4619/Images/Documentation/image-1632110016597.png" alt=""><figcaption></figcaption></figure>
